                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                                ...
                                <?php foreach ($data['features'] as $feature)
                            {
                                ...
                                ?>
                                <div style="background-image: url(/get_photo/{{$feature['photo_id']}}/500); width: 25%;" class="sc-discovery active wow fadeIn animated" data-wow-delay="0.3ms" data-wow-duration="800ms">
                                    <div class="inner-discovery">
                                        <div class="box-icon st-1">
                                            <i class="fas fa-check"></i>
                                        </div>
                                        <h5 class="title"><a href="about.html">{{ $feature['title'] }}</a></h5>
                                        <p class="sub f-mulish">{{ $feature['sub_title'] }}</p>
