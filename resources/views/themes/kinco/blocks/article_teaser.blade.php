  ...
  align-items: center; /* vertical center */">
                        <div class="col-xl-7 col-lg-7 col-md-12 col-12">
                            <div class="feature-about2">
                                <img src="/get_photo/{{ $post->photo_id }}/500" alt="Image" class="wow fadeInLeft animated" data-wow-delay="0.3ms" data-wow-duration="1000ms">
                            </div>
                        </div>
                            ...
                            <div class="sc-about-2">
                                <div class="title-heading">
                                    <div class="sub-heading clr-pri-3 f-mulish">
                                        <span class="inner-sub st-2">{{ $data['title'] }}</span>
                                    ...
                                    <h2 style="display: none;" class="title clr-pri-2">{{ $data['title'] }}
                                    </h2>
                                </div>
                                <div class="inner">
                                    <p> {!! $data['sub_title'] !!} </p>
                                    ...
                                    <a href="/tin-tuc-{{ $post->slug }}" class="fl-btn st-11">
