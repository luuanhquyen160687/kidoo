                                            ...
                                            <div class="item-quote" data-dot="">
                                                <div class="heading">
                                                    <div class="left fx">
                                                        ...
                                                        <ul>
                                                            <li><h4 class="name-author clr-pri-2"><?php echo $testimonial->name;?></h4></li>
                                                            <li><p class="clr-pri-5 f-mulish"><?php echo $testimonial->phone;?></p></li>
                                                        </ul>
                                                    </div>
                                                    <div class="right">
                                                ...
                                                <div class="wrap">
                                                    <p class="clr-pri-2">“ <?php echo $testimonial->content;?>”</p>
                                                </div>
                                            </div>
<?php
                        }
