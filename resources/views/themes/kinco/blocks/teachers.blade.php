...
<?php
                            ...
                            ?>
                                        <div class="sc-employee wow fadeInUp animated" data-wow-delay="0.3ms" data-wow-duration="800ms">
                                            <div class="box-feature"><img style="width: 300px;height: 300px; object-fit: cover;" src="/get_photo/<?php echo $teacher->id;?>/500" alt="Image"></div>
                                            <div class="box-content st-1">
                                                <h4 class="name"><a href="teacher-details.html" class="clr-pri-1"><?php echo $teacher->name;?></a></h4>
