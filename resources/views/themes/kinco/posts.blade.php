                        ...
                        <div class="col-xl-8 col-lg-8 col-md-12 col-12">
                            ...
                            <article class="box-blog-list">
                                ...
                                <div class="box-content">
                                    ...
                                    <h3 class="title-article-post"><a href="/tin-tuc-{{$post->slug}}">{{$post->title}} </a></h3>
                                    <p class="sub f-rubik" >
                                        {!! \Illuminate\Support\Str::words(strip_tags($post->content), 128, '...') !!}
                                  </p>
                                    <div class="box-btn">
                                        <a href="/tin-tuc-{{$post->slug}}" class="fl-btn st-1">
                            ...
                            <div class="themesflat-pagination st-2" data-wow-delay="200ms" data-wow-duration="1500ms">
                                <ul>
                                    {{-- Previous --}}
                                    <li class="custom  {{ $posts->onFirstPage() ? 'disabled' : '' }}">
                                        <a class=" muted3-color tran3s page-link" href="{{ $posts->previousPageUrl() }}"><i class="fa fa-angle-left" aria-hidden="true"></i></a>
                                    </li>
                                 {{-- Page Numbers --}}
                                  @foreach ($posts->links()->elements[0] ?? [] as $page => $url)
                                            <li class="  {{ $page == $posts->currentPage() ? 'custom' : '' }}">
                                                <a class="page-numbers {{ $page == $posts->currentPage() ? '' : '' }}  " href="{{ $url }}">{{ $page }}</a>
                                            </li>
                                        @endforeach
                              

                                  {{-- Next --}}
                                  <li class="custom st-2  {{ !$posts->hasMorePages() ? 'disabled' : '' }}">
                                        <a class=" muted3-color" href="{{ $posts->nextPageUrl() }}"><i class="fas fa-chevron-right" aria-hidden="true"></i></a>
                                    </li>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-12 col-12">
                            <div id="sidebar" class="sidebar-style2 wow fadeIn   animated" data-wow-delay="0.3ms" data-wow-duration="1200ms" style="visibility: visible; animation-duration: 1200ms; animation-delay: 0.3ms;">
                                <div class="inner-sidebar fl-st-1">
                                    <div class="widget widget-quote" style="display: none;">
                                    ...
                                    <div class="widget widget-category st-2">
                                        <h4 class="title-widget fl-ctm-1">Danh mục<span class="ctm-inner"></span></h4>
                                        <div class="list-category">
                                            <ul>
                                                <li class="fx"><a href="/tin-tuc"><span class="st wd-ctm">Tất cả</span></a></li>
                                                
                                                <?php
                                                foreach ($categories as $category)
                                                {
                                                ?>
                                                <li class="fx"><a href="/tin-tuc/?danh-muc={{ $category->slug }}"><span class="st wd-ctm">{{ $category->name }}</span></a></li>
                                                <?php } ?>
                                            </ul>
                                        </div>
                                    </div>
