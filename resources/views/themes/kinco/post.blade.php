                    ...
                    <div class="row">
                        <div class="col-xl-8 col-lg-8 col-md-12 col-12">
                            <article class="article">
                                <div class="feature-article wow fadeIn animated" data-wow-delay="0.3ms" data-wow-duration="1200ms" style="visibility: hidden; animation-duration: 1200ms; animation-delay: 0.3ms; animation-name: none;"><img src="/get_photo/{{$post->photo_id}}/1024" alt="Image"></div>
                                ...
                                <h3 class="title-article clr-pri-2">{{ $post->title }}</h3>
