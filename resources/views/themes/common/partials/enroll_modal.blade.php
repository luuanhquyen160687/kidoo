<div class="modal fade" id="enrollModal" tabindex="-1" aria-hidden="true">
        ...
        <div class="col-lg-6 position-relative d-none d-lg-block">
          <div class="bg-holder" style="background-image:url(https://mamnonbanmai.blog/assets/admin/img/bg/30.png);">
            <img src="'https://mamnonbanmai.blog/assets/admin/img/bg/30.png"/>
          </div>
          <!--/.bg-holder-->
        </div>
        <div class="col-lg-6">
          <div class="row flex-center h-100 g-0 px-4 px-sm-0">
            <div class="col col-sm-6 col-lg-7 col-xl-6"><a class="d-flex flex-center text-decoration-none mb-4" href="../../../index.html">
              ...
              <div class="text-center"><a class="fs-9 fw-bold" href="../../../pages/authentication/split/sign-up.html">Create an account</a></div>
            </div>
          </div>
        </div>
      </div>
