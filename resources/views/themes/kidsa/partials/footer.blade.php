 <!--<< Footer Section Start >>-->
        <footer class="footer-section section-bg fix">
            <div class="footer-top-shape">
                <img src="/themes/{{ config('theme.active') }}/assets/img/footer-top.png" alt="shape-img">
            </div>
            <div class="frame-shape">
                <img src="/themes/{{ config('theme.active') }}/assets/img/frame.png" alt="shape-img">
            </div>
            <div class="zebra-shape float-bob-y" style="top:0px">
            ...
            <div class="footer-widgets-wrapper">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                            <div class="single-footer-widget">
                                ...
                                <div class="footer-content">
                                    <p>
                                        {{$app['school']->name}} - {{$app['school']->slogan}}
                                    </p>
                        ...
                        <div class="col-xl-9 col-lg-8 col-md-6 ps-lg-5 wow fadeInUp" data-wow-delay=".5s">
                            <div class="contact-info-area" style="padding-top:0px">
                    ...
                    <div class="contact-info-items wow fadeInUp" data-wow-delay=".5s">
                        ...
                        <div class="content">
                            <p>Email</p>
                            <h3>
                                <a href="mailto:{{$app['school']->email}}">{{$app['school']->email}}</a>
                            </h3>
                        </div>
                    </div>
            ...
            <div class="footer-bottom">
                <div class="f-bottom-shape">
                    <img src="/themes/{{ config('theme.active') }}/assets/img/footer-bottom.png" alt="shape-img">
                </div>
                <div class="container">
                    <div class="footer-wrapper d-flex align-items-center justify-content-between">
                        <p class="wow fadeInLeft color-2" data-wow-delay=".3s">
                            © All Copyright 2024 by <a href="/">Kidsa</a>
                        </p>
