<section class="about-area pb-130" style="margin-top: 15px;">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <div class="about-thumb">
                        <img src="/get_photo/{{ $post->photo_id }}/500" alt="">
                ...
                <div class="col-lg-7">
                    <div class="about-content pl-70">
                        ...
                        <a class="main-btn" href="/tin-tuc-{{ $post->slug }}">Chi tiết <i class="fal fa-long-arrow-alt-right"></i></a>
                    </div> <!-- about content -->
                </div>
            </div> <!-- row -->
        </div>
