...
<?php
        ...
        <div class="col-lg-4 col-sm-6 col-xs-12">
          <div class="class-item">
            <div class="image">
              <img src="/themes/{{ config('theme.active') }}/images/classes/class_01.jpg" alt="class image" class="img-responsive">
            </div>
            <ul class="schedule">
              <li>
                <span>Class Size</span>
                <span><?php echo $program->class_count;?></span>
              </li>
              <li>
                <span>Years Old</span>
            ...
            <div class="content">
              <h4><a href="class-single.html"><?php echo $program->name;?></a></h4>
...
<section class="program-one" style="display: none;">
...
<?php
    ...
    <div class="program-one__item__image">
        <img src="<?php echo $program->thumbnail_path; ?>" alt="Toddler">
