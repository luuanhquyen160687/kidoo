          ...
          <div class="swiper-wrapper">
            <div class="teacher-item swiper-slide">
              <div class="teacher-image">
                <img src="/themes/{{ config('theme.active') }}/images/teachers/teacher_13.jpg" alt="teacher image" class="img-responsive">
              </div>
            ...
            <div class="teacher-item swiper-slide">
              <div class="teacher-image">
                <img src="/themes/{{ config('theme.active') }}/images/teachers/teacher_14.jpg" alt="teacher image" class="img-responsive">
              </div>
              <div class="teacher-content">
            ...
            <div class="teacher-item swiper-slide">
              <div class="teacher-image">
                <img src="/themes/{{ config('theme.active') }}/images/teachers/teacher_15.jpg" alt="teacher image" class="img-responsive">
              </div>
              <div class="teacher-content">
            ...
            <div class="teacher-item swiper-slide">
              <div class="teacher-image">
                <img src="/themes/{{ config('theme.active') }}/images/teachers/teacher_16.jpg" alt="teacher image" class="img-responsive">
              </div>
              <div class="teacher-content">
            ...
            <div class="teacher-item swiper-slide">
              <div class="teacher-image">
                <img src="/themes/{{ config('theme.active') }}/images/teachers/teacher_09.jpg" alt="teacher image" class="img-responsive">
              </div>
              <div class="teacher-content">
            ...
            <div class="teacher-item swiper-slide">
              <div class="teacher-image">
                <img src="/themes/{{ config('theme.active') }}/images/teachers/teacher_10.jpg" alt="teacher image" class="img-responsive">
              </div>
              <div class="teacher-content">
            ...
            <div class="teacher-item swiper-slide">
              <div class="teacher-image">
                <img src="/themes/{{ config('theme.active') }}/images/teachers/teacher_11.jpg" alt="teacher image" class="img-responsive">
              </div>
              <div class="teacher-content">
            ...
            <div class="teacher-item swiper-slide">
              <div class="teacher-image">
                <img src="/themes/{{ config('theme.active') }}/images/teachers/teacher_12.jpg" alt="teacher image" class="img-responsive">
              </div>
              <div class="teacher-content">
...
<section class="team-one" style="display: none;">
	...
	<div class="team-card__image kidearn-tilt" data-tilt-options='{ "glare": false, "maxGlare": 0, "maxTilt": 5, "speed": 700, "scale": 1 }'>
		<img style="width: 350px;height: 350px; object-fit: cover;" src="/get_photo/<?php echo $teacher->id;?>/500" alt="Jane cooper">
