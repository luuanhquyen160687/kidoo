...
@section('content')
<form class="ajax_form" action="/admin/students" class="mb-9" method="POST" >
  @csrf
          <div class="row g-3 flex-between-end mb-5">
            ...
            <div class="col-auto">
              ...
              <button class="btn btn-primary mb-2 mb-sm-0" type="submit">Thêm học sinh</button>
            </div>
          </div>
          <div class="row g-5">
            <div class="col-12 col-xl-9">
              ...
              <div class="col-sm-12 col-md-12" style="margin-bottom: 10px;">
               ...
               <div class="col-sm-12 col-md-12" style="margin-bottom: 10px;">
                <div class="form-floating">
                    ...
                    <input name="birthdate" class="form-control datetimepicker flatpickr-input" id="datetimepicker" type="text" placeholder="yyyy-mm-dd hour : minute" data-options="{'enableTime':false,'dateFormat':'y-m-d','disableMobile':true}" readonly="readonly">
              ...
              <div class="col-sm-12 col-md-12" style="margin-bottom: 10px;">
                 <div class="form-floating">
                  <input class="form-control" name="tuition_discount" id="tuition_discount_input" type="number" min="0" max="100" step="1" placeholder="Tuition discount">
              ...
              <div class="col-sm-12 col-md-12" style="margin-bottom: 10px;">
                 <div class="form-floating">
                  <input class="form-control" name="tuition_discount_reason" id="tuition_discount_reason_input" type="text" placeholder="Tuition discount reason">
                        ...
                        <div class="card mt-5">
                          ...
                          <div class="card-body pt-0">
                            ...
                            <div class="row gx-xxl-9" id="bulk-select-body">
                                ...
                                <div class="col-sm-12 col-md-12" style="margin-bottom: 10px;"> 
                                  <div class="form-floating">
                                    <input class="form-control" name="father_name" id="name_input" type="text" placeholder="Project title">
                                ...
                                <div class="col-sm-12 col-md-12" style="margin-bottom: 10px;"> 
                                  <div class="form-floating">
                                    <input class="form-control" name="father_phone" id="floatingInputGrid" type="text" placeholder="Project title">
                                 ...
                                 <div class="col-sm-12 col-md-12" style="margin-bottom: 10px;"> 
                                  <div class="form-floating">
                                    <input class="form-control" name="father_email" id="floatingInputGrid" type="text" placeholder="Project title">
                        ...
                        <div class="card mt-5">
                          ...
                          <div class="card-body pt-0">
                            ...
                            <div class="row gx-xxl-9" id="bulk-select-body">
                                ...
                                <div class="col-sm-12 col-md-12" style="margin-bottom: 10px;"> 
                                  <div class="form-floating">
                                    <input class="form-control" name="mother_name" id="name_input" type="text" placeholder="Project title">
                                    <label for="name_input">Tên </label>
                                    <div class="invalid-feedback"></div> 
                                  </div>
                                </div>
                                ...
                                <div class="col-sm-12 col-md-12" style="margin-bottom: 10px;"> 
                                  <div class="form-floating">
                                    <input class="form-control" name="mother_phone" id="floatingInputGrid" type="text" placeholder="Project title">
                                    <label for="floatingInputGrid">Điện thoại</label>
                                    <div class="invalid-feedback"></div> 
                                  </div>
                                </div>
                                 ...
                                 <div class="col-sm-12 col-md-12" style="margin-bottom: 10px;"> 
                                  <div class="form-floating">
                                    <input class="form-control" name="mother_email" id="floatingInputGrid" type="text" placeholder="Project title">
                                    <label for="floatingInputGrid">Email</label>
                                    <div class="invalid-feedback"></div> 
                                  </div>
                                </div>
