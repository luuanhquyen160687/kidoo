...
<div class="pb-9">
    <div class="row g-3 flex-between-end mb-5" style="padding-top:0px !important">
            <div class="col-auto"> 
              <h2 class="mb-2">Trang</h2>
              
            </div>
            <div class="col-auto">
              <button class="btn btn-phoenix-primary me-2 mb-2 mb-sm-0" type="button">Import</button>
              <a href="/admin/pages/create" class="btn btn-primary mb-2 mb-sm-0" type="submit">Thêm trang</a>
            </div>
    </div> 
                  ...
                  <tbody class="list" id="customers-table-body">
                    ...
                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                      ...
                      <td class="customer align-middle white-space-nowrap pe-5">
                        <a target="_blank" class="d-flex align-items-center text-body-emphasis" href="/<?php echo $page->routing_slug; ?>">
                          <div class="avatar avatar-m">
                            <img class="rounded-square" src="<?php echo (isset($page->thumbnail_path))? $page->thumbnail_path:"/assets/admin/trans.png"; ?>" alt="" /></div>
                          <p class="mb-0 ms-3 text-body-emphasis fw-bold"><?php echo $page->name; ?></p>
                        </a></td>
                      
                      <td class="align-middle actions  text-end pe-3">
                        <a href="/admin/pages/{{$page->id}}/edit"  class="btn btn-link text-body-quaternary p-0 me-2">
                         <span class="fas fa-edit text-body"></span>
                        </a>
                        <button data-bs-toggle="offcanvas" data-bs-target="#offcanvas_<?php echo $page->id; ?>" aria-controls="offcanvas_<?php echo $page->id; ?>" class="btn btn-link text-body-quaternary p-0 text-danger"> 
                          <span class="fa-solid fa-trash text-danger"></span> 
                        </button>                 
                          <div class="offcanvas offcanvas-end" id="offcanvas_<?php echo $page->id; ?>" tabindex="-1" aria-labelledby="offcanvas_<?php echo $page->id; ?>Label">
                           <div class="offcanvas-body " style="padding-top: 100px;" >
                            ...
                            <div class="offcanvas-body bottom" style="position: absolute;bottom: 0;width: 100%;">
                              Xóa bài viết này?
                              <div class="mt-3">
                                <form method="POST" action="/admin/pages/<?php echo $page->id; ?>">
                                  @csrf
                                  @method('DELETE')
