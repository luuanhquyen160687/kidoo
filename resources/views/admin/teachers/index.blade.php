...
<div class="row">
    <div class="row g-3 flex-between-end mb-5" style="padding-top:0px !important">
            ...
            <div class="col-auto">
              ...
              <a href="/admin/teachers/create" class="btn btn-primary mb-2 mb-sm-0" type="submit">Thêm giáo viên</a>
            </div>
    </div> 
                  ...
                  <tbody class="list" id="customers-table-body">
                    ...
                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                      ...
                      <td class="align-middle actions  text-end pe-3">
                        <a href="/admin/teachers/{{$teacher->id}}/edit"  class="btn btn-link text-body-quaternary p-0 me-2">
