...
@section('content')
<form class="ajax_form" action="/admin/classes/{{$class->id}}" class="mb-9" method="POST" >
  @csrf
   @method('PUT')
            ...
            <div class="col-12 col-xl-9">
              ...
              <div class="col-sm-12 col-md-12" style="margin-bottom: 10px;">  
                 <div class="form-floating">
                  <input value="{{$class->name}}" class="form-control" name="name" id="floatingInputGrid" type="text" placeholder="Project title">
              ...
              <div class="col-sm-12 col-md-12" style="margin-bottom: 10px;">
                <div class="form-floating">
                  <select name="program_id" class="form-select" id="program_select">
                    ...
                    {
                    ?>
                    <option  data-photo_id="<?php echo $level->photo_id;?>" data-thumbnail_path="<?php echo $level->thumbnail_path;?>" data-tuition="<?php echo $level->tuition;?>" <?php echo ($level->id==$class->program_id)? 'selected':''; ?> value="<?php echo $level->id;?>"><?php echo $level->name; ?></option>
                    <?php
                    }
                    ?>
                  </select>
                  <label for="level_select">Chương trình học</label>
                  <div class="invalid-feedback"></div>
                </div>
              </div>
              ...
              <div class="col-sm-12 col-md-12" style="margin-bottom: 10px;">
                <div class="form-floating">
                  <select name="campus_id" class="form-select" id="campus_select">
                    ...
                    {
                    ?>
                    <option <?php echo ($campus->id==$class->campus_id)? 'selected':''; ?> value="<?php echo $campus->id;?>"><?php echo $campus->name; ?></option>
                    <?php
                    }
                    ?>
                  </select>
              ...
              <div class="col-sm-12 col-md-12" style="margin-bottom: 10px;">
                <div class="form-floating">
                  <input class="form-control" value="{{$class->year}}" name="year" id="floatingInputGrid" type="text" placeholder="Year">
              ...
              <div class="col-sm-12 col-md-12" style="margin-bottom: 10px;">
                <div class="form-floating">
                  <input class="form-control" value="{{$class->tuition}}" name="tuition" id="floatingInputGrid" type="text" placeholder="Học phí">
              ...
              <div class="col-sm-12 col-md-12" style="margin-bottom: 10px;">
                <div class="form-floating">
                  <select name="teacher_id" class="form-select" id="floatingSelectTeam">
                    ...
                    {
                    ?>
                    <option <?php echo ($teacher->id==$class->teacher_id)? 'selected':''; ?> value="<?php echo $teacher->id;?>"><?php echo $teacher->name; ?></option>
                    <?php
                    }
                    ?>
                  </select>
              ...
              <div class="col-sm-12 col-md-12" style="margin-bottom: 10px;">
                ...
                <select name="assistant_teacher_ids[]" class="form-select" id="assistantTeacherIds" multiple size="5">
                  ...
                  {
                  ?>
                  <option <?php echo $assistantTeacherIds->contains($teacher->id) ? 'selected' : ''; ?> value="<?php echo $teacher->id;?>"><?php echo $teacher->name; ?></option>
                  <?php
                  }
                  ?>
                </select>
