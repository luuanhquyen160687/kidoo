                            ...
                            <div class="row gx-xxl-9" id="bulk-select-body">
                              <div class="col-sm-12 col-md-12" style="margin-bottom: 10px;"> 
                                 <div class="form-floating input-group mb-3">
                                  <input name="school_email" id="school_email_input"  class="form-control" type="text" placeholder="Recipient's username" aria-label="Recipient's username" aria-describedby="basic-addon2">
                                  <span class="input-group-text" id="basic-addon2">@<?php echo $app['school']->domain;?></span>
                                  <label for="floatingInputGrid">email</label>
                                  <div class="invalid-feedback"></div> 
                                </div>
