             ...
             <div class="col-sm-12 col-md-12">
                <div class="card mt-5">
                  <div class="card-body pt-0">
                    ...
                    @include('admin.components.file_picker', ['id' => 'post_files_picker', 'name' => 'files', 'label' => 'Thêm file, ảnh cho bài viết'])
                  </div>
                </div>
              </div>
            </div>
                      ...
                      <div class="row gx-3">
                        <div class="col-12 col-sm-6 col-xl-12">
                          <div class="mb-4">
                            ...
                            @include('admin.components.file_picker', ['id' => 'post_photo_picker', 'name' => 'photo_id', 'label' => 'Chọn ảnh đại diện', 'multiple' => false])
                            <div class="invalid-feedback"></div>
                          </div>
                        </div>
