...
@section('content')
 <form class="ajax_form" action="/admin/programs" class="mb-9" method="POST" >
  @csrf
          <div class="row g-3 flex-between-end mb-5">
            <div class="col-auto">
              <h2 class="mb-2">Thêm chương trình học</h2>
              
            </div>
            <div class="col-auto">
              <a href="/admin/programs" class="btn btn-phoenix-secondary me-2 mb-2 mb-sm-0" type="button">Quay về</a>
              <button class="btn btn-primary mb-2 mb-sm-0" type="submit">Thêm chương trình học</button>
            </div>
          </div>
          <div class="row g-5">
            <div class="col-12 col-xl-9">
              ...
              <div class="col-sm-12 col-md-12" style="margin-bottom: 10px;"> 
                <div class="form-floating " >
                    <input  class="form-control" type="text" name="tuition" id="create-boardwizard-name" placeholder="Tiêu đề bài viết" value="">
              ...
              <div class="col-sm-12 col-md-12" style="margin-bottom: 10px;"> 
                <div class="form-floating " >
                    <input  class="form-control" type="text" name="class_count" id="create-boardwizard-name" placeholder="Tiêu đề bài viết" >
             ...
             <div class="col-sm-12 col-md-12">
                  ...
                  <div class="col-sm-6 col-md-6">
                    <div class="form-floating">
                      <select name="age_from" class="form-select" id="floatingSelectTeam">
                        ...
                        {
                        ?>
                        <option value="<?php echo $i;?>">  <?php echo $i; ?> tháng <?php if (($i%6)==0) echo "(".($i/12)." tuổi)";?></option>
                        <?php
                        }
                        ?>
                      </select>
              ...
              <div class="col-sm-12 col-md-12"> 
                <div class="form-floating">
                    ...
                    <input id="post_content" type="hidden" name="introduction" value="">  
                            ...
                            <div class="row gx-xxl-9" id="bulk-select-body">
                              <div class="col">
                                <div class="files-container" data-files-container="data-files-container">
                                  ...
                                  {
                                  ?>
                                  <div id="preview_<?php echo $i;?>" class="text-center" style="display:none">
                                    <div class="file-box-wrapper img-zoom-hover">
                                      <div class="position-relative h-100">
                                        <div class="file-box overflow-hidden">
                                          <img id="preview_img" class="w-100 h-100 object-fit-cover" src="" alt=""></div>
                                          <input type="hidden" id="file_uploaded"  name="files[<?php echo $i;?>]" value="">
                                      </div>
                                      <div class="dropdown lh-1 position-absolute top-0 end-0 mt-2 me-2">
                                        <button onclick="delete_uploadFiles(<?php echo $i;?>)" class="btn btn-square-sm text-body position-relative z-1" type="button" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent">
