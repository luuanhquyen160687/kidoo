                        ...
                        <div class="card mt-5">
                          ...
                          <div class="card-body pt-0">
                            <div class="myfiles-action-bar mx-n4 mb-4" style="padding: 20px;">
                              <h6 class="mb-0 text-body-tertiary" id="file-manager-replace-element">Thông tin liên hệ</h6> 
                            </div>
                ...
                <div class="col-sm-12 col-md-12"> 
                      <div class="form-floating">
                        ...
                        <div class="card mt-5">
                          ...
                          <div class="card-body pt-0">
                            <div class="myfiles-action-bar mx-n4 mb-4" style="padding: 20px;">
                              <h6 class="mb-0 text-body-tertiary" id="file-manager-replace-element">Email nhà trường</h6> 
                            </div>
                            <div class="row gx-xxl-9" id="bulk-select-body">
                              <div class="col-sm-12 col-md-12" style="margin-bottom: 10px;"> 
                                <div class="form-floating">
                                  <input class="form-control" value="{{$teacher->school_email}}" name="school_email" id="floatingInputGrid" type="text" placeholder="Project title">
                                  <label for="floatingInputGrid">Email nhà trường</label>
                                  <div class="invalid-feedback"></div> 
                                  </div>
                                </div>
                            </div>
                      ...
                      <div class="row gx-3">
                        <div class="col-12 col-sm-6 col-xl-12">
                          <div class="mb-4">
                                ...
                                <input class="d-none"  id="photo_id_browser" type="file" />
                                    ...
                                    <div class="position-relative bg-body-quaternary rounded-square cursor-pointer d-flex flex-center ">
                                      <div class="avatar avatar-5xl">
                                        <img class="rounded-square" src="<?php echo $teacher->thumbnail_path? $teacher->thumbnail_path:'/assets/admin/trans.png'; ?>" alt="" /></div>
                            ...
                            <input type="hidden" id="photo_id"  name="photo_id"  value="<?php echo $teacher->photo_id; ?>">
